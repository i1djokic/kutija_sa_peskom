#!/bin/bash
# Script to install dependencies for Simple VM (Linux Learning) on Linux
# Uses libvirt/KVM as the hypervisor

set -e

echo "=========================================="
echo "Simple Linux VM for Learning - Linux Setup"
...
echo "2. Start the VM: vagrant up --provider=libvirt"
